...
export const comparePages: ComparePage[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Which has better resale value in Kelowna?", a: "Both add resale value. Solid hardwood holds slightly higher premium feel in luxury Lower Mission and Upper Mission homes. Engineered is the Kelowna market default, and buyers don't penalize it." },
    ],
  },
  {
