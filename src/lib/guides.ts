...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      {
        heading: "Kitchen flooring in Kelowna",
        body:
      ...
      {
        heading: "Bathroom flooring in Kelowna",
        body:
      ...
      {
        heading: "Basement flooring in Kelowna",
        body:
      ...
      {
        heading: "Bedroom flooring in Kelowna",
        body:
    ...
    faqs: [
      ...
      { q: "What flooring is warmest for Kelowna winters?", a: "Carpet is warmest underfoot, followed by luxury vinyl plank and laminate with thicker underpads. Tile is coldest, so pair it with in-floor heating for a Kelowna bathroom or kitchen." },
