...
const TYPES = [
  {
    ...
    bullets: [
      ...
      "Nylon and polyester face-fibre options, and we'll explain the trade-offs on-site",
...
const curated: ServiceCombo[] = [
  ...
  },
  {
    ...
    intro:
      "LVP is the fastest-growing category in Kelowna for a reason: 100% waterproof, scratch-resistant, wood-look visuals, and installed in a day. We stock rigid-core SPC vinyl plank from Mohawk, TORLYS, Opus Floors, Twelve Oaks, Home's Pros, and Fuzion, all in stock and ready to ship in 3-5 days.",
    bullets: [
      "Rigid-core SPC luxury vinyl plank (100% waterproof)",
      "Click-lock installation over most existing subfloors",
      "Wide-plank, narrow-plank, herringbone patterns available",
