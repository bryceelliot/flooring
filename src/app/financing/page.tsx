...
const faqs = [
  {
    ...
    a: "Financing is available to a wide range of credit profiles. Ask our team for details and we&apos;ll walk you through the options that fit your situation.",
  },
  {
      ...
      <section className="py-24 bg-light">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <AnimateOnScroll className="text-center mb-12">
            <h2 className="text-2xl sm:text-4xl font-black text-charcoal">Financing FAQ</h2>
          </AnimateOnScroll>
