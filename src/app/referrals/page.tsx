...
import { ArrowRight, Phone, CheckCircle2, Users, DollarSign } from "lucide-react";
...
const steps = [
  { num: "1", title: "Tell us who", body: "Call (250) 860-7847 or text us with your friend's name and a phone number, and make sure they know you're sending us their way." },
    ...
    <>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-white/60 text-lg mt-4">Send their name and number and we&apos;ll take it from here.</p>
