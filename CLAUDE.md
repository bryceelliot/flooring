...
```
python "c:/Users/bryce/Desktop/Projects/Digital Marketing/make-zip.py"
```
...
- `make-zip.py` lives at `c:\Users\bryce\Desktop\Projects\Digital Marketing\make-zip.py` — do not delete it; its `base` path must point at this project's `out\` folder
